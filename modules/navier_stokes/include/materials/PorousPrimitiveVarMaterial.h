...
protected:
  ...
  const ADVariableGradient * const _grad_var_sup_vel_y;
  const ADVariableValue & _var_sup_vel_z;
  const ADVariableGradient * const _grad_var_sup_vel_z;
  ...
  ADMaterialProperty<RealVectorValue> * const _grad_sup_vel_y;
  ADMaterialProperty<Real> & _sup_vel_z;
  ADMaterialProperty<RealVectorValue> * const _grad_sup_vel_z;

...
#include "GasMixPorousConservedVarMaterial.h"
#include "NS.h"

// FluidProperties includes
#include "SinglePhaseFluidProperties.h"

registerMooseObject("NavierStokesApp", GasMixPorousConservedVarMaterial);

InputParameters
GasMixPorousConservedVarMaterial::validParams()
{
...
ADReal
GasMixPorousConservedVarMaterial::computeSpeed() const
{
...
GasMixPorousConservedVarMaterial::computeQpProperties()
{
  ...
  //std::cout<<_v[_qp]<<std::endl;
  //std::cout<<_pressure[_qp]<<std::endl;
  //std::cout<<_specific_internal_energy[_qp]<<std::endl;
  // --------------------------------------------------------
  ...
  // Modified ----------------------------------------------
  ADReal dT_dv, dT_de, dT_dx;
  _fluid.T_from_v_e_X(_v[_qp], _specific_internal_energy[_qp], mass_fractions, _T_fluid[_qp], dT_dv, dT_de, dT_dx);
  _grad_T_fluid[_qp] = dT_dv * grad_v + dT_de * grad_e + dT_dx * grad_mf;  
  // --------------------------------------------------------
}

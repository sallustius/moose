...
#include "GasMixPCNSFVStrongBC.h"
#include "NS.h"
#include "SinglePhaseFluidProperties.h"
#include "Function.h"
#include "MfrPostprocessor.h"

registerMooseObject("NavierStokesApp", GasMixPCNSFVStrongBC);

InputParameters
GasMixPCNSFVStrongBC::validParams()
{
...
GasMixPCNSFVStrongBC::GasMixPCNSFVStrongBC(const InputParameters & params)
  : FVFluxBC(params),
...
ADReal
GasMixPCNSFVStrongBC::computeQpResidual()
{
  ...
  const auto e_boundary = _fluid.e_from_p_T_X(pressure_boundary, T_fluid_boundary, mass_fractions_boundary);

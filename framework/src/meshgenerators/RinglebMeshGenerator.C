...
RinglebMeshGenerator::RinglebMeshGenerator(const InputParameters & parameters)
...
std::vector<Real>
RinglebMeshGenerator::arhopj(const Real & gamma, const std::vector<Real> & q, const int & index)
{

...
template <>
InputParameters
validParams<MeshBaseImageSampler>()
{
...
Real
MeshBaseImageSampler::sample(const Point & p)
{
#ifdef LIBMESH_HAVE_VTK
...
void
MeshBaseImageSampler::vtkMagnitude()
{
#ifdef LIBMESH_HAVE_VTK
...
void
MeshBaseImageSampler::vtkShiftAndScale()
{
#ifdef LIBMESH_HAVE_VTK
...
void
MeshBaseImageSampler::vtkThreshold()
{
#ifdef LIBMESH_HAVE_VTK
...
MeshBaseImageSampler::imageFlip(const int & axis)
{

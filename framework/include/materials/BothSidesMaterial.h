 ...
 */
class BothSidesMaterial : public MaterialBase,
...
public:
  ...
  BothSidesMaterial(const InputParameters & parameters);
...
BothSidesMaterial::getMaterialProperty(const std::string & name)
{
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getMaterialPropertyOld(const std::string & name)
{
  // Check if the supplied parameter is a valid imput parameter key
  std::string prop_name = deducePropertyName(name);
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getMaterialPropertyOlder(const std::string & name)
{
  // Check if the supplied parameter is a valid imput parameter key
  std::string prop_name = deducePropertyName(name);
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getMaterialPropertyByName(const std::string & prop_name)
{
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getMaterialPropertyOldByName(const std::string & prop_name)
{
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getMaterialPropertyOlderByName(const std::string & prop_name)
{
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getNeighborMaterialProperty(const std::string & name)
{
  // Check if the supplied parameter is a valid imput parameter key
  std::string prop_name = deducePropertyName(name);
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getNeighborMaterialPropertyByName(const std::string & prop_name)
{
  MaterialBase::checkExecutionStage();
  // The property may not exist yet, so declare it (declare/getMaterialProperty are referencing the
  // same memory)
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getNeighborMaterialPropertyOld(const std::string & name)
{
  // Check if the supplied parameter is a valid imput parameter key
  std::string prop_name = deducePropertyName(name);
...
template <typename T>
const MaterialProperty<T> &
BothSidesMaterial::getNeighborMaterialPropertyOlder(const std::string & name)
{
  // Check if the supplied parameter is a valid imput parameter key
  std::string prop_name = deducePropertyName(name);
